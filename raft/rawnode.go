...
func (r *SoftState) equal(rhs *SoftState) bool {
	return r.Lead == rhs.Lead && r.RaftState == rhs.RaftState
}
...
func (rn *RawNode) Ready() Ready {
	...
	rt := rn.Raft
	rd := Ready{
		Entries:          rt.RaftLog.unstableEntries(),
		CommittedEntries: rt.RaftLog.nextEnts(),
		Messages:         rt.msgs,
	}
