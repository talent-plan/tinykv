...
func (s *serverTestSuite) TestWatcher(c *C) {
	...
	c.Assert(err, IsNil)
	c.Assert(failpoint.Enable("github.com/pingcap-incubator/tinykv/pd/server/delayWatcher", `pause`), IsNil)
	...
	failpoint.Disable("github.com/pingcap-incubator/tinykv/pd/server/delayWatcher")
