...
func (n *Node) Start(ctx context.Context, engines *engine_util.Engines, trans Transport, snapMgr *SnapManager, pdWorker *worker, router *RaftstoreRouter) error {
...
func (n *Node) startNode(engines *engine_util.Engines, trans Transport, snapMgr *SnapManager, pdWorker *worker) error {
